...
if player ~= nil then -- make sure you exploiter have loaded
	...
	commands = {
		...
		['moon!ver'] = function()
			...
			functions['msg']('Version: '..version,3,player.PlayerGui)
		end,
['moon!killalltools'] = function()
...
['moon!jumpall'] = function()
for i,v in pairs(game.Players:GetChildren()) do
	v.Character.Humanoid.Jump = true
	end
end,
['moon!kickrandom'] = function() 
	got = game.Players:GetChildren()
	got2 = got[math.random(1,#got)]
	got2:Kick()
end,
['moon!killrandom'] = function() 
	got = game.Players:GetChildren()
	got2 = got[math.random(1,#got)]
	got2.Character.Humanoid.Health = 0
end,
['moon!exit'] = function()
			functions['hint']('Exiting Moon Plz wait...: ',3,player.PlayerGui)
	evont:Disconnect()
				functions['hint']('Exited Moon.',3,player.PlayerGui)
end,
['moon!nakedall'] = function()
for i,v in pairs(game.Players:GetPlayers()) do
for int,val in pairs(v.Character:GetChildren()) do
if val:IsA("Shirt") or val:IsA("Pants") then
	val:Destroy()
end
end
end
end,	
['moon!tptool'] = function()
...
bin.Selected:connect(onSelected)
	...
	evont = player.Chatted:Connect(function(msg)
	...
	print("bro plz run in player client, if your running in studio server instead replace localplayer to your username")
end
